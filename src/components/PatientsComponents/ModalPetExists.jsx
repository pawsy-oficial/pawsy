      ...
      <div className="fixed top-0 bottom-0 left-0 right-0 bg-[#111111]/60">
        <div className="flex  items-center fixed top-2/4 left-1/2 -translate-x-2/4 -translate-y-2/4 bg-white p-16 rounded-lg">
          ...
          <div className="pl-6">
            ...
            <input type="text" name="" id="" className="border-b-2 w-64" placeholder="ex.: 123.456.789-00"/>
            <div className="pt-8 w-full flex justify-end gap-6">
              <button onClick={() => props.setYes(!props.isYes)} type="" className="px-3 bg-[#04AD34] rounded-lg p-1">
                <p className="text-sm">Adicionar</p>
              </button>
              <button onClick={() => props.setYes(!props.isYes)} type="" className="px-3 bg-[#DC3545] rounded-lg p-1">
