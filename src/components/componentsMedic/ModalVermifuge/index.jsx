...
export function ModalVermifuge({ isOpen, setOpen }) {
  if (isOpen) {
    return (
      <div className={style.background}>
        <div className={style.modal}>
          ...
          <div className="flex pt-6 flex-col gap-1">
            ...
            <input
              type="text"
              className="bg-gray-white rounded-lg pl-2 pr-4 w-full h-8 text-xs text-[#909090] border border-primary hover:border-primary"
            />
          </div>
