...
export default function CardClinics(props){
    ...
    const informacoes = {img: props.img, nameClinic: props.nameClinic, OpenClose: props.openOrClose}

    return(
        <button onClick={() => navigate("/pacientes-clinica", {state: { informacoes }})}>
            <div className="bg-white rounded-lg shadow-sm flex p-4 gap-4 w-60 mt-4">
                <div className="w-16">
                    <img src={props.img} alt="Clinica" className="rounded-full"/>
                </div>
