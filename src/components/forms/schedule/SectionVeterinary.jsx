...
function SectionAddVeterinary({ names, remove, index, register, control, setValue }) {
    ...
    const handleVeterinarioChange = (selectedVeterinarioId) => {
        const novaEspecialidade = names.find((veterinario) => String(veterinario.idMedico) === String(selectedVeterinarioId))?.especialidade;
