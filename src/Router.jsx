...
import Receitas from "./pages/medic/revenues";
...
export default function Router() {
  return (
    <Routes>
      ...
      />
      <Route path="/pacientes-clinica" element={<PatientsForMedic />} />
      <Route path="/paciente" element={<ViewPatient />} />
      <Route path="/vacinas-e-vermifugação" element={<Vaccine />} />
      <Route path="/receitas-medicas" element={<Receitas />} />
      <Route path="/nova-receita" element={<NewRevenues />} />
    </Routes>
  );
}
