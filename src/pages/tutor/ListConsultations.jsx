							...
							>
								...
								>
									...
									>
										...
										>
											<div
												className="min-w-[3rem] h-12 rounded-full overflow-hidden border-2 border-primary"
											>
												<img
											...
											>
												<h3
													className="text-lg font-lato font-bold capitalize"
												>
													{infoClinic.Nome}
												</h3>
												<span
										...
										<div
											className="flex flex-col items-center text-zinc-700 font-bold font-lato p-3 border-2 border-pawsy-green rounded-lg"
										>
											<span>
												{scheduleDate}
											</span>
										...
										>
											{
												pets.map((infoPet, index) => (
													<label
														className="label_select w-full flex gap-2 items-center cursor-pointer hover:bg-primary/5 transition-all duration-700 p-1 rounded"
														key={index}
